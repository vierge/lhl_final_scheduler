...
Event.create(name: "book reading", description: "make sure to read often, really helps people gain knowledge", location: "at the library", start_time: nil, photo: nil, end_time: nil, group_id: 4, colour: "green")
...
Reservation.create(user_id: 2, event_id: 1, going: false)
Reservation.create(user_id: 3, event_id: 1, going: false)
Reservation.create(user_id: 4, event_id: 1, going: false)
Reservation.create(user_id: 6, event_id: 1, going: false)
